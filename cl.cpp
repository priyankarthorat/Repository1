...
printf("Add numbers or press = to quit \n");
...
printf("= for answer and c to continue\n");
char eqs;
scanf("%c",&eqs);
scanf("%c",&eq);
//flushall();
...
printf("This program subtract given number from last given number or press q to quit \n");
...
printf("Enter = to get the answer otherwise Enter c to continue\n");
char eqs;
scanf("%c",&eqs);
scanf("%c",&eq);
